<template>
    <div >
        <template v-for="(item, index) in menuList">
            <div class="DropdownMenuClass" :key="index">
                <Dropdown  v-if="item.children.length !== 1" :key="index" @on-click="changeMenu">
                ...
                <Dropdown v-else  :key="index" @on-click="changeMenu">
...
<style lang="less">
.DropdownMenuClass .ivu-select-dropdown {
    // width: inherit;
    max-height: 600px;
    margin-left: 65px;
}
