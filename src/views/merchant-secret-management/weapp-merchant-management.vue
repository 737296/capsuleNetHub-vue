<template>
  <div id="weapp-merchant-management" class="page-root">
    <div class="form-box">
      <Form ref="formData" :model="formData" :label-width="96">
        <FormItem prop="merchantNo" label="商户号：" class="cal-from-item">
          <Input
            type="text"
...
export default {
  ...
  beforeDestroy () {},
  components: {
    EditPopup: resolve => require(['./components/weapp-edit-popup'], resolve)
  },
  methods: {
...
<style lang="less" src="./weapp-merchant-management.less" scoped></style>
