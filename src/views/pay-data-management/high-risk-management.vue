...
import baseApi from './high-risk-management-api'
...
const getRealFromData = (formData) => {
  ...
  // 阻断时间
  if (res.daterange && res.daterange.length === 2) {
    res.blockStartTime = res.daterange[0]
    res.blockEndTime = res.daterange[1]
  }
...
<style lang="less" src="./high-risk-management.less" scoped>
</style>
