<template>
  <Pupup v-model="popup.show" :loading="popup.loading" class-name="popup-model" width="none">
    <template slot="header"> 支付渠道规则限制 </template>
    <template slot="body">
      ...
      [
        {
          ...
          component: 'Select',
          value: '',
          rule: [{ required: true, message: '请选择商品限制', trigger: 'blur' }],
          options: []
        },
        { span: 1 },
        {
          ...
          component: 'Select',
          value: '',
          rule: [{ required: true, message: '请选择用户限制', trigger: 'blur' }],
          options: []
        }
      ],
      [
